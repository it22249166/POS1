 ...
 * @param args
 */
function generateChunkedCalls(fn, chunkSize, concurrency, data) {
    var _i, limit, i, dataChunked;
    var args = [];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(i * chunkSize < data.length)) return [3 /*break*/, 4];
                dataChunked = data.slice(i * chunkSize, (i + 1) * chunkSize);
                return [4 /*yield*/, limit.apply(void 0, __spread([fn, dataChunked], args))];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
exports.generateChunkedCalls = generateChunkedCalls;
/**
 ...
 */
exports.concu = function (fn, chunkSize, concurrency, data) {
    var args = [];
    ...
    return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all(generateChunkedCalls.apply(void 0, __spread([fn, chunkSize, concurrency, data], args)))];
